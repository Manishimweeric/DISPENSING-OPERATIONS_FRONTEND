...
const CalibrationList = () => {
    ...
    const handleCalibirationSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${API_URL}/api/calibrations/${selectedCalibrations.id}/`, {
                method: 'PUT',
                headers: {
    ...
    return (
        <div className="container mx-auto mt-10">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold">Station Calibration Records</h1>
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden">
                        ...
                        <div className="flex justify-end space-x-4 mt-6">
                            <button
                                ...
                                disabled={selectedCalibration.report !== null} // Disable if report is not null
                                className={`py-1 px-3 rounded ${
                                    selectedCalibration.report === null 
            ...
            {isMaintenanceModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 z-50">
                    <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden">
                        <h3 className="text-2xl font-semibold text-gray-600 mb-6">Adding Calibration Report</h3>
